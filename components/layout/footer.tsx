...
export async function Footer() {
    ...
    return (
        <footer
            ...
            className="border-t border-zinc-200 bg-white text-zinc-700 dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-300"
        >
            <div className="mx-auto grid w-full max-w-7xl gap-10 px-4 py-12 sm:grid-cols-2 sm:px-6 sm:py-14 lg:grid-cols-[1.8fr_1fr_1fr] lg:px-8">
                <div>
                    <Link
                        href="/"
                ...
                <nav aria-labelledby="footer-info" className="sm:pl-2">
                    <h2
                        id="footer-info"
                        className="px-2 text-xs font-semibold uppercase tracking-[0.16em] text-zinc-400 dark:text-zinc-500"
                    >
