...
export default async function IncidentDetailPage({ params }: { params: Promise<{ public_id: string }> }) {
    ...
    return (
        <main className="flex-1 bg-stone-50 text-zinc-950 dark:bg-zinc-950 dark:text-zinc-100">
            <section className="border-b border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900"><div className="mx-auto max-w-7xl px-6 py-5 lg:px-8"><Breadcrumbs items={breadcrumbItems} homeLabel="প্রচ্ছদ" ariaLabel="ঘটনার অবস্থান" /></div></section>
                ...
                <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_320px] lg:items-start">
                    <div>
                        <article className="overflow-hidden border border-zinc-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
                            <header className="border-b border-zinc-200 px-6 py-8 dark:border-zinc-800 sm:px-10 sm:py-10">
                            ...
                            <div className="px-6 py-8 sm:px-10 sm:py-10"><p className="whitespace-pre-wrap text-base leading-8 text-zinc-700 dark:text-zinc-300 sm:text-lg">{incident.description}</p></div>
                            <footer className="border-t border-zinc-200 bg-stone-50 px-6 py-6 dark:border-zinc-800 dark:bg-zinc-950 sm:px-10">
